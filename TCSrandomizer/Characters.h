...
const uint16_t c_Extratoggle = 0x1;
const uint16_t c_DefaultCharacter = 0x2;
const uint16_t c_Fake = 0x4;
const uint16_t c_NoLevel = 0x8;
const uint16_t c_AllEpisodes = 0x10;
const uint16_t c_Vgreen = 0x20;
const uint16_t c_Mount = 0x40;
const uint16_t c_Vehicle = 0x80;
const uint16_t c_Turret = 0x100;
const uint16_t c_GrabThing = 0x200;

//These are exclusive to ships so they can reuse flags.
const uint64_t Tow = 0x2;
const uint64_t TieDoor = 0x4;

const uint64_t Flatten = 0x2;
const uint64_t Buck = 0x4;
...
struct Playable {
	...
	Playable(std::string myName, std::string myRealName, int myPrice, int myAddress, float mySpeed,
		uint64_t myAttributes, uint16_t myCategories = 0);
