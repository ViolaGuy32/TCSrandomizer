...
void makeCharactersAndLevels() {
	...
	landocalrissian = new Playable("landocalrissian", "Lando Calrissian", 15000, 0x0, 1.2f,
	...
	lando_palaceguard = new Playable("lando_palaceguard", "Lando (Palace Guard)", 15000, 0x0, 1.2f,
	...
	greedo = new Playable("greedo", "Greedo", 60000, 0x7f2050, 1.2f,
	...
	bespinguard = new Playable("bespinguard", "Bespin Guard", 15000, 0x0, 1.2f,
	...
	bossk = new Playable("bossk", "Bossk", 75000, 0x7f2058, 1.2f,
		{Lever, Build, Box, Jump, Dive, Attack, Shoot, Grapple, Bounty, Chokeable, Trickable});
	...
	admiralackbar = new Playable("admiralackbar", "Admiral Ackbar", 33000, 0x0, 1.4f,
	...
	dengar = new Playable("dengar", "Dengar", 70000, 0x0, 1.2f,
