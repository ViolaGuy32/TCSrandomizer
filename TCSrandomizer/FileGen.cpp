...
void speedUp(int episode, std::string file, std::initializer_list<unsigned int> ln = {},
	std::string goLev = "") {
	std::string eps[] = {
		"EPISODEI", "EPISODEII", "EPISODEIII", "EPISODEIV", "EPISODEV", "EPISODEVI"};
...
void fileGen() {
	...
	//lineDeleter(out + Negotiations->path + "NEGOTIATIONS_INTRO/EP1_FAILEDNEG_INTRO2.TXT", {1, 2,
	//3}); lineDeleter(out + BHP->path + "PURSUIT_INTRO/PURSUIT_INTRO.TXT", {1}); lineDeleter(out +
	//Vader->path + "VADER_INTRO/VADER_INTRO.TXT", {1}); lineDeleter(out + ITDS->path +
	//"DEATHSTAR2BATTLE_INTRO/DEATHSTAR2BATTLE_INTRO.TXT", {2});
	...
	txtIns(TPM + "NEGOTIATIONS/NEGOTIATIONS_C/NEGOTIATIONS_C.TXT", "negotiations_status",
		{{567, 9}}, 15);
	...
	binaryWrite(EXE, "DEAE4D", 0xDB074); //allows mushroom to collapse without cutscene

	speedUp(1, "PODSPRINT", {1});
	txtIns(TPM + "PODSPRINT/PODSPRINT_A/PODSPRINT_A.TXT", "//",
		{20, 21, 22, 23, 26, 27, 28, 30, 31, 34, 35});
	//check code
	...
	txtIns(
		CLN + "KAMINO/KAMINO_F/KAMINO_F.GIT", "//", {896, 897, 1067, 1068, 1069, 1288, 1289, 1290});
	...
	txtIns(CLN + "FACTORY/FACTORY_G/FACTORY_G.GIT", "completelevel \"newlevel=factory_status\"",
		{{287, 3}}, 8);
	...
	txtIns(
		ANH + "DEATHSTARRESCUE/DEATHSTARRESCUE_C/DEATHSTARRESCUE_C.TXT", "status", {{316, 25}}, 5);
	...
	txtIns(
		ANH + "DEATHSTARESCAPE/DEATHSTARESCAPE_C/DEATHSTARESCAPE_C.TXT", "status", {{154, 25}}, 5);
	txtIns(
		ANH + "DEATHSTARESCAPE/DEATHSTARESCAPE_C/DEATHSTARESCAPE_C.TXT", "status", {{197, 25}}, 5);
	...
	txtIns(
		ANH + "DEATHSTARBATTLE/DEATHSTARBATTLE_D/DEATHSTARBATTLE_D.TXT", "status", {{593, 25}}, 5);
	txtIns(
		ANH + "DEATHSTARBATTLE/DEATHSTARBATTLE_D/DEATHSTARBATTLE_D.GIT", "status", {{971, 39}}, 5);
	...
	txtIns(
		EMP + "DAGOBAH/DAGOBAH_B/AI/LEVEL.SCP", "gotonewlevel \"level=dagobah_e\"", {{129, 3}}, 35);
	...
	txtIns(
		EMP + "CLOUDCITYESCAPE/CLOUDCITYESCAPE_C/CLOUDCITYESCAPE_C.TXT", "status", {{132, 25}}, 5);
	...
	appendFile(JDI + "ENDORBATTLE/ENDORBATTLE_INTRO/ENDORBATTLE_INTRO.TXT",
		"cutscene \"episodeii\\ep2_kamino_intro1\"");
	...
	appendFile(JDI + "EMPERORFIGHT/EMPERORFIGHT_INTRO/EMPERORFIGHT_INTRO.TXT",
		"cutscene \"episodeii\\ep2_factory_intro2\"");
	...
	txtIns(JDI + "DEATHSTAR2BATTLE/DEATHSTAR2BATTLE_G/DEATHSTAR2BATTLE_G.TXT", "status", {{72, 26}},
		5);
}
